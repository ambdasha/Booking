...
const docTemplate = `{
        ...
        "/admin/rooms/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Новые данные комнаты",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/rooms/{id}/availability": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Начало периода в RFC3339",
                        "name": "from",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Конец периода в RFC3339",
                        "name": "to",
                        "in": "query",
                        "required": true
                    }
    ...
    "definitions": {
        "dto.AvailabilityResponse": {
            ...
            "properties": {
                "blocks": {
                    "description": "занятые админскими блокировками",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.Interval"
                    }
                },
                "from": {
                    "type": "string"
                ...
                "reservations": {
                    "description": "занятые активными бронями",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.Interval"
                    }
